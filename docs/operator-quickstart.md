# Operator Quickstart — Other-Livestock Farm Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0149** (`cloud-itonami-isic-0149`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0149.git
cd cloud-itonami-isic-0149
```
...
- Blueprint governor key: `other-livestock-farm-operations-governor`
- Likely source path: `otherlivestockops.governor.cljc`
